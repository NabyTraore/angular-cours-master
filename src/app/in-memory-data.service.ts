...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    ...
    const eleve7: Eleve = new Eleve(6, 'MBA2 Expert Web et Digital', 'toto', 'toutou', 45, 'filiere6', 'description6', 'pouet@pouet.fr');
    const eleve8: Eleve = new Eleve(7, 'MBA3 Expert Web et Digital', 'tata', 'tatayé', 35, 'filiere6', 'description6', 'pouet@pouet.fr');
    const eleves = [eleve1, eleve2, eleve3, eleve4, eleve5, eleve6, eleve7, eleve8];
